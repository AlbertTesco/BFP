/********************************************************************************
** Form generated from reading UI file 'dialog_parallelogram.ui'
**
...
#ifndef UI_DIALOG_PARALLELOGRAM_H
#define UI_DIALOG_PARALLELOGRAM_H
...
public:
    ...
    void setupUi(QDialog *Dialog_parallelogram)
    {
        if (Dialog_parallelogram->objectName().isEmpty())
            Dialog_parallelogram->setObjectName(QString::fromUtf8("Dialog_parallelogram"));
        Dialog_parallelogram->resize(1136, 667);
        Dialog_parallelogram->setStyleSheet(QString::fromUtf8("Dialog_parallelogram\n"
"{\n"
...
"}"));
        verticalLayout = new QVBoxLayout(Dialog_parallelogram);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        tab_rect = new QTableWidget(Dialog_parallelogram);
        ...
        graphicsView = new QGraphicsView(Dialog_parallelogram);
        graphicsView->setObjectName(QString::fromUtf8("graphicsView"));

        verticalLayout->addWidget(graphicsView);

        table_ang = new QTableWidget(Dialog_parallelogram);
        ...
        retranslateUi(Dialog_parallelogram);

        QMetaObject::connectSlotsByName(Dialog_parallelogram);
    } // setupUi

    void retranslateUi(QDialog *Dialog_parallelogram)
    {
        Dialog_parallelogram->setWindowTitle(QCoreApplication::translate("Dialog_parallelogram", "Dialog", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tab_rect->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\233\320\265\320\262\320\260\321\217 \321\201\321\202\320\276\321\200\320\276\320\275\320\260", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tab_rect->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\237\321\200\320\260\320\262\320\260\321\217 \321\201\321\202\320\276\321\200\320\276\320\275\320\260", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tab_rect->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\234\320\265\320\275\321\214\321\210\320\265\320\265 \320\276\321\201\320\275\320\276\320\262\320\260\320\275\320\270\320\265", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tab_rect->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\221\320\276\320\273\321\214\321\210\320\265\320\265 \320\276\321\201\320\275\320\276\320\262\320\260\320\275\320\270\320\265", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tab_rect->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\222\321\213\321\201\320\276\321\202\320\260", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tab_rect->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\237\320\273\320\276\321\211\320\260\320\264\321\214", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = tab_rect->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\237\320\265\321\200\320\270\320\274\320\265\321\202\321\200", nullptr));
        QTableWidgetItem *___qtablewidgetitem7 = tab_rect->verticalHeaderItem(0);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\227\320\275\320\260\321\207\320\265\320\275\320\270\320\265", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = table_ang->horizontalHeaderItem(0);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\233\320\265\320\262\321\213\320\271 \320\275\320\270\320\266\320\275\320\270\320\271 \321\203\320\263\320\276\320\273", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = table_ang->horizontalHeaderItem(1);
        ___qtablewidgetitem9->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\233\320\265\320\262\321\213\320\271 \320\262\320\265\321\200\321\205\320\275\320\270\320\271 \321\203\320\263\320\276\320\273", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = table_ang->horizontalHeaderItem(2);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\237\321\200\320\260\320\262\321\213\320\271 \320\262\320\265\321\200\321\205\320\275\320\270\320\271 \321\203\320\263\320\276\320\273", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = table_ang->horizontalHeaderItem(3);
        ___qtablewidgetitem11->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\237\321\200\320\260\320\262\321\213\320\271 \320\275\320\270\320\266\320\275\320\270\320\271 \321\203\320\263\320\276\320\273", nullptr));
        QTableWidgetItem *___qtablewidgetitem12 = table_ang->verticalHeaderItem(0);
        ___qtablewidgetitem12->setText(QCoreApplication::translate("Dialog_parallelogram", "\320\227\320\275\320\260\321\207\320\265\320\275\320\270\320\265", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Dialog_parallelogram: public Ui_Dialog_parallelogram {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DIALOG_PARALLELOGRAM_H
